...
{
    int status = 0;
    IG5A_F1_Get_JumpCode(ctx, slaveAddress, F1->JumpCode, &status);
    IG5A_F1_Get_ForvardReverseRunDisable(ctx, slaveAddress, F1->ForvardReverseRunDisable, &status);
    IG5A_F1_Get_AccelPattern(ctx, slaveAddress, F1->AccelPattern, &status);
    IG5A_F1_Get_DecelPattern(ctx, slaveAddress, F1->DecelPattern, &status);
    IG5A_F1_Get_StopModeSelect(ctx, slaveAddress, F1->StopModeSelect, &status);
    IG5A_F1_Get_DCBrakeStartFrequency(ctx, slaveAddress, F1->DCBrakeStartFrequency, &status);
    IG5A_F1_Get_DCBrakeWaitTime(ctx, slaveAddress, F1->DCBrakeWaitTime, &status);
    IG5A_F1_Get_DCBrakeVoltage(ctx, slaveAddress, F1->DCBrakeVoltage, &status);
    IG5A_F1_Get_DCBrakeTime(ctx, slaveAddress, F1->DCBrakeTime, &status);
    IG5A_F1_Get_DCBrakeStartVoltage(ctx, slaveAddress, F1->DCBrakeStartVoltage, &status);
    IG5A_F1_Get_DCBrakeStartTime(ctx, slaveAddress, F1->DCBrakeStartTime, &status);
    IG5A_F1_Get_TimeForMegnatizingAMotor(ctx, slaveAddress, F1->TimeForMegnatizingAMotor, &status);
    IG5A_F1_Get_JogFrequency(ctx, slaveAddress, F1->JogFrequency, &status);
    IG5A_F1_Get_MaxFrequency(ctx, slaveAddress, F1->MaxFrequency, &status);
    IG5A_F1_Get_BaseFrequency(ctx, slaveAddress, F1->BaseFrequency, &status);
    IG5A_F1_Get_StartFrequency(ctx, slaveAddress, F1->StartFrequency, &status);
    IG5A_F1_Get_FrequencyHighLowLimit(ctx, slaveAddress, F1->FrequencyHighLowLimit, &status);
    IG5A_F1_Get_FrequencyHighLimit(ctx, slaveAddress, F1->FrequencyHighLimit, &status);
    IG5A_F1_Get_FrequencyLowLimit(ctx, slaveAddress, F1->FrequencyLowLimit, &status);
    IG5A_F1_Get_TorqueBoostSelect(ctx, slaveAddress, F1->TorqueBoostSelect, &status);
    IG5A_F1_Get_TorqueBoostInForvardDirection(ctx, slaveAddress, F1->TorqueBoostInForvardDirection, &status);
    IG5A_F1_Get_TorqueBoostInReverseDirection(ctx, slaveAddress, F1->TorqueBoostInReverseDirection, &status);
    IG5A_F1_Get_VFPattern(ctx, slaveAddress, F1->VFPattern, &status);
    IG5A_F1_Get_UserVFFrequency1(ctx, slaveAddress, F1->UserVFFrequency1, &status);
    IG5A_F1_Get_UserVFVoltage1(ctx, slaveAddress, F1->UserVFVoltage1, &status);
    IG5A_F1_Get_UserVFFrequency2(ctx, slaveAddress, F1->UserVFFrequency2, &status);
    IG5A_F1_Get_UserVFVoltage2(ctx, slaveAddress, F1->UserVFVoltage2, &status);
    IG5A_F1_Get_UserVFFrequency3(ctx, slaveAddress, F1->UserVFFrequency3, &status);
    IG5A_F1_Get_UserVFVoltage3(ctx, slaveAddress, F1->UserVFVoltage3, &status);
    IG5A_F1_Get_UserVFFrequency4(ctx, slaveAddress, F1->UserVFFrequency4, &status);
    IG5A_F1_Get_UserVFVoltage4(ctx, slaveAddress, F1->UserVFVoltage4, &status);
    IG5A_F1_Get_OutputVoltageAdjustments(ctx, slaveAddress, F1->OutputVoltageAdjustments, &status);
    IG5A_F1_Get_EnergySavingLevel(ctx, slaveAddress, F1->EnergySavingLevel, &status);
    IG5A_F1_Get_ElectronicThermalSelect(ctx, slaveAddress, F1->ElectronicThermalSelect, &status);
    IG5A_F1_Get_ElectronicThermalLevelFor1min(ctx, slaveAddress, F1->ElectronicThermalLevelFor1min, &status);
    IG5A_F1_Get_ElectronicThermalLevelForCont(ctx, slaveAddress, F1->ElectronicThermalLevelForCont, &status);
    IG5A_F1_Get_MotorCoolingMethod(ctx, slaveAddress, F1->MotorCoolingMethod, &status);
    IG5A_F1_Get_OverloadWarningLevel(ctx, slaveAddress, F1->OverloadWarningLevel, &status);
    IG5A_F1_Get_OverloadWarningTime(ctx, slaveAddress, F1->OverloadWarningTime, &status);
    IG5A_F1_Get_OverloadTripSelect(ctx, slaveAddress, F1->OverloadTripSelect, &status);
    IG5A_F1_Get_OverloadTripLevel(ctx, slaveAddress, F1->OverloadTripLevel, &status);
    IG5A_F1_Get_OverloadtripTime(ctx, slaveAddress, F1->OverloadtripTime, &status);
    IG5A_F1_Get_StallPreventionSelect(ctx, slaveAddress, F1->StallPreventionSelect, &status);
    IG5A_F1_Get_StallPreventionLevel(ctx, slaveAddress, F1->StallPreventionLevel, &status);
    IG5A_F1_Get_StallPreventionDurDecVolLimSel(ctx, slaveAddress, F1->StallPreventionDurDecVolLimSel, &status);
    IG5A_F1_Get_SaveUpDownFrequencySelect(ctx, slaveAddress, F1->SaveUpDownFrequencySelect, &status);
    IG5A_F1_Get_SaveUpDownFrequency(ctx, slaveAddress, F1->SaveUpDownFrequency, &status);
    IG5A_F1_Get_UpDownModeSelect(ctx, slaveAddress, F1->UpDownModeSelect, &status);
    IG5A_F1_Get_UpDownStepFrequency(ctx, slaveAddress, F1->UpDownStepFrequency, &status);
    IG5A_F1_Get_DrawnRunModeSelect(ctx, slaveAddress, F1->DrawnRunModeSelect, &status);
    IG5A_F1_Get_DrawRate(ctx, slaveAddress, F1->DrawRate, &status);
}
